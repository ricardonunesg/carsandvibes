...
export default component$(() => {
        ...
        const state = useStore<AppState>({
                ...
                // MENU LATERAL DE CATEGORIAS (estado global, render fica no Menu.tsx)
        ...
        useVisibleTask$(({ track }) => {
                ...
                track(() => state.showCategoriesMenu);

                state.showCart || state.showMenu || state.showCategoriesMenu
        ...
        useOn(
                ...
                $((event: unknown) => {
                        if ((event as KeyboardEvent).key === 'Escape') {
                                ...
                                state.showCategoriesMenu = false;
                        }
                })
        );
